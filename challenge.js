...
const dogWeight = dogs.map(dog => dog.weight ** 0.75 * 28);
...
// 5.is any dog eating exactly the amount of food that is recommended
...
// create shallow copy and sort by recommended food portion (ascending)
